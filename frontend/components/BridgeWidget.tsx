...
const POPULAR_TOKENS = [
  ...
  { symbol: 'USDC', name: 'USD Coin', icon: '💵', address: '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48' },
  { symbol: 'USDT', name: 'Tether', icon: '💲', address: '0xdAC17F958D2ee523a2206206994597C13D831ec7' },
  { symbol: 'DAI', name: 'Dai', icon: '🪙', address: '0x6B175474E89094C44Da98b954EedeAC495271d0F' },
  { symbol: 'WBTC', name: 'Wrapped Bitcoin', icon: '🟠', address: '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599' },
]
      ...
      >
          ...
          <div className="relative">
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${fromChain.color} flex items-center justify-center text-xl`}>
                  {fromChain.icon}
                </div>
              ...
              {showFromChainSelect && (
                ...
                >
                  {SUPPORTED_CHAINS.map((chain) => (
                    ...
                    >
                      <div className={`w-8 h-8 rounded-lg bg-gradient-to-br ${chain.color} flex items-center justify-center text-lg`}>
                        {chain.icon}
                      </div>
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${toChain.color} flex items-center justify-center text-xl`}>
                  {toChain.icon}
                </div>
                <div className="text-left">
                  <div className="font-semibold text-brown-900 dark:text-brown-100">
        ...
        <button
          ...
          disabled={!isConnected || !amount || parseFloat(amount) <= 0 || txStatus === 'pending'}
          className={`
            w-full py-4 rounded-2xl font-bold text-white transition-all duration-300
            ${!isConnected || !amount || parseFloat(amount) <= 0 || txStatus === 'pending'
            ...
            >
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    {['0.1', '0.5', '1.0'].map((slippage) => (
                      <button
                        key={slippage}
                        className="px-3 py-1 rounded-lg glass text-sm hover:bg-purple-100 dark:hover:bg-purple-900/30"
                      >
                        {slippage}%
                      </button>
                    ))}
                    <input
                      type="number"
                      placeholder="Custom"
                      className="px-3 py-1 rounded-lg glass text-sm bg-transparent outline-none w-20"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    <button className="flex-1 px-3 py-2 rounded-lg glass text-sm hover:bg-purple-100 dark:hover:bg-purple-900/30">
                      <FaGasPump className="inline mr-1" />
                      Slow
                    </button>
                    <button className="flex-1 px-3 py-2 rounded-lg glass text-sm bg-purple-100 dark:bg-purple-900/30 border border-purple-300 dark:border-purple-700">
